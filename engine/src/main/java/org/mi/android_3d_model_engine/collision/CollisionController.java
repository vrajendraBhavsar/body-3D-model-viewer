package org.mi.android_3d_model_engine.collision;
    ...
    public boolean onEvent(EventObject event) {
        ...
        if (event instanceof TouchEvent) {
            ...
            if (touchEvent.getAction() == TouchEvent.CLICK) {
                ...
                Object3DData objectHit = CollisionDetection.getBoxIntersection(objects, view.getWidth(), view.getHeight(), view.getViewMatrix(), view.getProjectionMatrix(), x, y);
                if (objectHit != null) {
                    // intersection point
                    ...
                    if (this.scene.isCollision()) {
                        ...
                        float[] point = CollisionDetection.getTriangleIntersection(objectHit, view.getWidth(), view.getHeight(), view.getViewMatrix(), view.getProjectionMatrix(), x, y);
