package org.mi.android_3d_model_engine.services;
...
import org.mi.android_3d_model_engine.collision.CollisionEvent;
import org.mi.android_3d_model_engine.controller.TouchEvent;
import org.mi.android_3d_model_engine.event.SelectedObjectEvent;
...
import org.mi.android_3d_model_engine.model.Dimensions;
import org.mi.android_3d_model_engine.model.Object3DData;
import org.mi.android_3d_model_engine.model.Transform;
import org.mi.android_3d_model_engine.objects.Point;
import org.mi.android_3d_model_engine.services.collada.ColladaLoaderTask;
import org.mi.android_3d_model_engine.services.gltf.GltfLoaderTask;
import org.mi.android_3d_model_engine.services.stl.STLLoaderTask;
import org.mi.android_3d_model_engine.services.wavefront.WavefrontLoaderTask;
...
import org.mi.util.math.Math3DUtils;
...
public class SceneLoader implements LoadListener, EventListener {
    ...
    public boolean onEvent(EventObject event) {
        ...
        if (event instanceof TouchEvent) {
            ...
            if (touch.getAction() == TouchEvent.Action.ROTATE && selectedObject != null) {
                ...
                //Code which was responsible for letting sliced part move was here
            }
    ...
    private void rescale(List<Object3DData> datas, float newScale, float[] newPosition) {
        ...
        /**
         * Uncomment this code for adjusting scaling of a model based on the UNIT set from constant.java
         **/
//        for (Object3DData data : datas){
