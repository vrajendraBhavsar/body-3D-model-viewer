...
import org.mi.android_3d_model_engine.objects.Cube;
import org.mi.android_3d_model_engine.services.LoadListener;
import org.mi.android_3d_model_engine.services.LoadListenerAdapter;
import org.mi.android_3d_model_engine.services.LoaderTask;
import org.mi.android_3d_model_engine.services.collada.ColladaLoader;
import org.mi.android_3d_model_engine.services.wavefront.WavefrontLoader;
import org.mi.android_3d_model_engine.util.Exploder;
    ...
    protected List<Object3DData> build() throws Exception {
        ...
        try {
            ...
            try {
                ...
                }).load(new URI("android://org.mi.dddmodel2/assets/models/teapot.obj")).get(0);
            ...
            try {
                ...
                }).load(new URI("android://org.mi.dddmodel2/assets/models/cube.obj")).get(0);
            ...
            try {
                ...
                }).load(new URI("android://org.mi.dddmodel2/assets/models/ToyPlane.obj")).get(0);
            ...
            try {
                // this has heterogeneous faces
                Object3DData obj53 = new ColladaLoader().load(new URI("android://org.mi.dddmodel2/assets/models/cowboy.dae"), new LoadListenerAdapter(){
                    @Override
                    public void onLoad(Object3DData obj53) {
                        obj53.setColor(new float[] { 1.0f, 1.0f, 1f, 1.0f });
                        Rescaler.rescale(obj53, 2f);
