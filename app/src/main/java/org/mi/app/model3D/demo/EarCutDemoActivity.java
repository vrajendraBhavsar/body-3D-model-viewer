package org.mi.app.model3D.demo;
...
import org.mi.android_3d_model_engine.camera.CameraController;
import org.mi.android_3d_model_engine.collision.CollisionDetection;
import org.mi.android_3d_model_engine.controller.TouchController;
...
import org.mi.android_3d_model_engine.view.ModelSurfaceView;
...
/*    @Override
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            WavefrontLoaderTask task = new WavefrontLoaderTask(this, URI.create("android://org.mi.dddmodel2/assets/models/triangle1.obj"), new LoadListener() {
                @Override
                public void onStart() {
            ...
            WavefrontLoaderTask task2 = new WavefrontLoaderTask(this, URI.create("android://org.mi.dddmodel2/assets/models/triangle2.obj"), new LoadListener() {
                @Override
                public void onStart() {
                    // provide context to allow reading resources
                    ContentUtils.setThreadActivity(EarCutDemoActivity.this);
